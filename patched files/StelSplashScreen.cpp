...
void SplashScreen::SplashScreenWidget::paintEvent(QPaintEvent* event)
{
   ...
   QString version = StelUtils::getApplicationPublicVersion() + " FS2"; // FS2 text added to version number displayd on splash screen to indicate this release includes the FS2 patches
